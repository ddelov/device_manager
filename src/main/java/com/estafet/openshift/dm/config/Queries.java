...
public interface Queries {
		...
		String SQL_LOAD_LAST_ACTIVE_OWNERSHIP = "select " + Constants.COL_ID + "," + Constants.COL_CUST_ID + "," +
						Constants.COL_THING_TYPE + "," + Constants.COL_SN + "," + Constants.COL_OWN + "," + Constants.COL_VALID_FROM + "," + Constants.COL_VALID_TO +"," + Constants.COL_STATUS +
		...
		String SQL_INSERT_DEV_OWNERSHIP = "insert into " + Constants.SCHEMA_NAME + '.' + Constants.TABLE_NAME_DEVICE_OWNERSHIP +
						" (" + Constants.COL_CUST_ID + "," + Constants.COL_THING_TYPE + "," + Constants.COL_SN +
						"," + Constants.COL_OWN + "," + Constants.COL_VALID_FROM + "," + Constants.COL_VALID_TO +
						"," + Constants.COL_THING_NAME + "," + Constants.COL_STATUS +
						" ) values (?,?,?,?,?,?,?,?)";
		...
		String SQL_GET_ALL_DEV_OWNERSHIP = "select " + Constants.COL_ID + ", " + Constants.COL_THING_NAME + "," +
						Constants.COL_THING_TYPE + "," + Constants.COL_SN + "," + Constants.COL_OWN + "," + Constants.COL_VALID_FROM +
						"," + Constants.COL_VALID_TO + "," + Constants.COL_CUST_ID + "," + Constants.COL_STATUS +
						" from " + Constants.SCHEMA_NAME + '.' + Constants.TABLE_NAME_DEVICE_OWNERSHIP +
						" where (" +
						//all next parameters are today(formatted)
						" (" + Constants.COL_VALID_FROM + " <= ? and " + Constants.COL_VALID_TO + " is NULL )" +
		...
		String SQL_GET_DEV_OWNERSHIP_BY_CUSTOMER = "select " + Constants.COL_ID + ", " + Constants.COL_THING_NAME + "," +
						Constants.COL_THING_TYPE + "," + Constants.COL_SN + "," + Constants.COL_OWN + "," + Constants.COL_VALID_FROM +
						"," + Constants.COL_VALID_TO + "," + Constants.COL_CUST_ID + "," + Constants.COL_STATUS +
						" from " + Constants.SCHEMA_NAME + '.' + Constants.TABLE_NAME_DEVICE_OWNERSHIP +
						" where (" +
		...
		String SQL_CHANGE_DEV_STATUS = "update " + Constants.SCHEMA_NAME + '.' + Constants.TABLE_NAME_DEVICE_OWNERSHIP +
